...
class Register extends Component {
  ...
  handleSubmit = event => {
    ...
    axios.post(`http://localhost:8080/Adaptive/registration`, {
...
<br/>
       ...
       <input type="num"  NumberFormat format="+91 ### ### ####" mask="_" id="form_phone" name="phone" onChange={this.handlePhoneChange} class="form-control" placeholder="* Phone Number" required autofocus/>
       ...
       <input type="password" id="retype_password" name="Cpassword" onChange={this.handlepasswordChange} class="form-control" placeholder="* Confirm Password" required autofocus/>
       <span class="error_form" id="retypepassword_error_message"></span>
<br/>
        <input value="submit" type="button" class="sbmt_btn"  />
